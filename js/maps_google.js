function initMap() {
	...
	var emporium= {lat: 19.494191, lng: -154.946565};
	...
	var markerEmporium = new google.maps.Marker({
		position: emporium,
		map: map,
		title: 'Puna Gallery and Gift Emporium',
		animation: google.maps.Animation.DROP,
		icon: logo_sm
	});
	...
	markerEmporium.addListener('click', function() {
		windowInfo.setContent('<div class="GMtitle">Puna Gallery and Gift Emporium</div><div class="GMtext"><br>Mon-Fri: tbd<br>Sat-Sun: tbd</div>');
